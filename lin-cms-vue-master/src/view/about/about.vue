<template>
  <div class="container">
    <div class="lin-info">
      <div class="lin-info-left">
        <div class="welcome">
          ...
          <div class="subtitle">
            <div class="guide">您还可以点击活水之井官方网站，查看更多信息</div>
            <!--<div class="link"><a href="https://www.talelin.com" target="_blank">https://talelin.com</a></div>-->
            <div class="link"><a href="https://blog.csdn.net/u014508939/article/list" target="_blank">https://blog.csdn.net</a></div>
          </div>
        </div>
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity">435,744</div>
          </div>
        </div>
    ...
    <div class="information">
      <div class="personal">
        <div class="personal-title">晨曦遇晓</div>
        <img src="../../assets/image/about/tostring.jpg" class="personal-avatar" />
        <div class="personal-influence">
          <div class="personal-influence-item">
            <div class="personal-influence-num color1">435744</div>
            <div class="personal-influece-label">总访问量</div>
          </div>
          <div class="personal-influence-item">
            <div class="personal-influence-num color2">161</div>
            <div class="personal-influece-label">粉丝</div>
          </div>
          <div class="personal-influence-item">
            <div class="personal-influence-num color3">141</div>
            <div class="personal-influece-label">作品</div>
          </div>
        </div>
        <el-tabs v-model="activeName" class="personal-tabs">
          <el-tab-pane label="最新作品" name="first">
            <div class="content">linux安装配置nginx</div>
          </el-tab-pane>
          <el-tab-pane label="最热作品" name="second">
            <div class="content">覆盖索引、联合索引、索引下推</div>
          </el-tab-pane>
        </el-tabs>
      </div>
      <div class="article">
        ...
        <div class="article-list">
          <div class="article-item" @click="handleArticle('https://blog.csdn.net/u014508939/article/details/71080409')">
            <img class="article-thumb" src="../../assets/image/about/open-source.jpg" alt="" />
            <div class="article-detail">
              <p class="article-detail-title">mysql的优化原理</p>
              <div class="article-detail-content">
                说起MySQL的查询优化，相信大家收藏了一堆奇淫技巧：不能使用SELECT *、不使用NULL字段、合理创建索引、为字段选择合适的数据类型..... 你是否真
                的理解这些优化技巧？是否理解其背后的工作原理？在实际场景下性能真有提升吗？我想未必。因而理解这些优化建议背后的原理就尤为重要，希望本文...
              </div>
              <div class="article-tool">
                <div class="pubdate">2017-05-02 13:31:04</div>
                <div class="article-about">
                  <span><i class="iconfont icon-shoucang"></i>153</span>
          ...
          <div class="article-item" @click="handleArticle('https://blog.csdn.net/u014508939/article/details/100561133')">
            <img class="article-thumb" src="../../assets/image/about/open-source.jpg" alt="" />
            <div class="article-detail article-last">
              <p class="article-detail-title">mysql里groupBy之后取每个分组最新的一条(或者按照自定义的规则排序)</p>
              <div class="article-detail-content">
                经常在分组查询之后 需要的是分组的某行数据，例如更新时间最新的一条数据，详见下表：然后根据goods_id进行分组查询 取分组后最新的一条数据 我们
                需要的结果是id为3和id为2的这2条数据 但是执行后查询的结果是：可以看出来 得到的结果是3和1,这显然不是我们需要的结果，因为在分组之前数据库就默...
              </div>
              <div class="article-tool">
                <div class="pubdate">2019-09-05 16:43:34</div>
                <div class="article-about">
                  <span><i class="iconfont icon-shoucang"></i>53</span>
                  <el-divider direction="vertical"></el-divider>
                  <span><i class="iconfont icon-pinglun"></i>20</span>
                  <el-divider direction="vertical"></el-divider>
                  <span><i class="iconfont icon-fenxiang"></i>16</span>
                </div>
              </div>
            </div>
          </div>
