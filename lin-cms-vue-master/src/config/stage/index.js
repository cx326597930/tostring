...
import goodsConfig from './goods' // 引入商品管理路由文件
import documentConfig from './document' // 引入商品管理路由文件
import removeAdminConfig from './removeAdmin' // 引入回收站管理文件
import videoConfig from './video' // 引入视频管理文件
